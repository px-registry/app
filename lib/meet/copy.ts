...
export const MEET = {
  ...
  sync: {
    ...
    listHeading: "接続済みの端末",
    thisDevice: "この端末",
    /** 端末ごとの同期状態（Hiroto 確定 2026-06-17）: 一覧は状態 label「同期中」を出す
     *  （旧「同期」ボタンは action に見えて弱い）。off は「同期しない」。 */
    syncingLabel: "同期中",
    syncOn: "同期",
    syncOff: "同期しない",
    ...
    /** 接続完了（確定 2026-06-17）。AIキー無しの分岐つき。 */
      ...
      title: "つながりました。",
      body: "この端末でも、Antenna、Talk、Memoryを使えます。",
      noKey: "AIキーはまだこの端末にありません。Runするには、この端末でもAI接続してください。",
      toKey: "AI接続へ",
      later: "あとで",
    },
    /** handoff 失敗（確定 2026-06-17）。 */
    failed: {
      title: "つなげませんでした。",
      body: "QRの期限が切れたか、承認が完了しませんでした。もう一度やり直してください。",
      retry: "もう一度QRを表示",
    },
    /** 既存端末が無い場合（確定 2026-06-17・締め版）。 */
    noDevice: {
      title: "接続済みの端末がありません。",
      body: "控えがない場合、MemoryとTalkの履歴は戻せません。Antennaなど公開済みの内容は、本人確認後に戻ります。",
      recover: "復帰コードで戻る",
      fresh: "新しく始める",
    },
    /** この端末の同期を止める（確定 2026-06-17・締め版）。
     *  確認ボタンは「同期を止める」（Hiroto 確定 — 「同期しない」は設定値に見えて弱い／停止操作を名指す）。 */
    pauseThis: {
      title: "この端末への同期を止めます。",
      body: "この端末にまだ届いていない内容は削除されます。すでにこの端末やほかの端末に保存された内容は、それぞれの端末に残ります。",
      go: "同期を止める",
      cancel: "やめる",
    },
