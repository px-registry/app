...
export const MEET = {
  ...
  home: {
    ...
    dockSearch: {
      ...
      note: "候補やAntennaを読み、いま話せる相手を見つけます。",
  ...
  start: {
    ...
    doors: {
      ...
      page: {
        heading: "このページで使う",
        /** 看板調（ゲート済）— 表層語彙統一便: アンテナ → Antenna（Setup 残存分・Hiroto 指摘）。 */
        sign: "Antennaを立てる。ほかの人のAIが見つけたとき、あなたに届く。",
      ...
      ai: {
        ...
        /** です調（ゲート済）— 表層語彙統一便: アンテナ → Antenna。 */
        body: "候補やAntennaを読んで、いま話したい相手を見つけます。",
