...
//
// This is the spine's closed road. surface_shape (4) and intent (3) are the
// ONLY public board vocabulary. They do not grow: the strategy may say
// "sale/auction/match", but the public/canonical mapping is fixed —
//   sale  → offered
...
/** surface_shape — how the activity is shaped. Strict, 4 values, never extended. */
export const SURFACE_SHAPES = ["offered", "auction_like", "matching", "stand"] as const;
